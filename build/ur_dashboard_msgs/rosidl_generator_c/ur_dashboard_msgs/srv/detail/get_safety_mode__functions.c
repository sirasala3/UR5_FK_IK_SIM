...
ur_dashboard_msgs__srv__GetSafetyMode_Request__create(void)
{
...
ur_dashboard_msgs__srv__GetSafetyMode_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
ur_dashboard_msgs__srv__GetSafetyMode_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
